...
#Convert ethernet address into hex string
def eth_addr (a) :
  b = "%.2x:%.2x:%.2x:%.2x:%.2x:%.2x" % (ord(a[0]) , ord(a[1]) , ord(a[2]), ord(a[3]), ord(a[4]) , ord(a[5]))
  return b

#create a AF_PACKET, this is done on a packet level 
#define ETH_P_ALL        
try:
...
#This program is protocol base, Below are the the code for each protocol
		...
		#TCP Packets
			...
			print 'Type : ' + str(tcp_type) + ' Code : ' + str(code) + ' Checksum : ' + str(checksum)
